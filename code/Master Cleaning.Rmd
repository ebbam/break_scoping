...
for (i in vars){
  print(sum(is.na(edgar$emissions[edgar$ipcc_code == i])))
  for(j in 1:2){
...
# 
# ggsave(
#   filename = here("out", "/ghg_emissions_by_sector_plots.pdf"), 
...
# setdiff(c(EU31, OECD), owid_all$country)
