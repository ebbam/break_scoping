...
# Without Luxembourg
# Standard models
standard <- readRDS(here("output/temp/nolux_simpleets.RDS")) %>% rbind(readRDS(here("output/temp/nolux_further_ets_20.RDS"))) %>% 
  mutate(ets_05 = ifelse(grepl("EU_ETS_05", source), 1, 0),
         ets_08 = ifelse(grepl("EU_ETS_08", source), 1, 0),
         ets_13 = ifelse(grepl("EU_ETS_13", source), 1, 0),
         ets_yes = ets_05 + ets_08 + ets_13)
...
shares <- readRDS(here("output/temp/shares_noar_nolux.RDS")) %>% 
  ...
  rbind(readRDS(here("output/temp/shares_ets_noar.RDS"))) %>% 
        mutate(ets_05 = ifelse(grepl("EU_ETS_05", source), 1, 0),
         ets_08 = ifelse(grepl("EU_ETS_08", source), 1, 0),
         ets_13 = ifelse(grepl("EU_ETS_13", source), 1, 0),
         ets_yes = ets_05 + ets_08 + ets_13)
...
```{r, echo = FALSE, cache = TRUE}
# gr_noLX <- here("output/temp/growth_rate_nolux.RDS")
# 
# gr_noLX %>% filter(source == "d.l_edgar_v7 ~ d.lgdp_wb + d.lpop + d.lgdp_wb_sq + g.cdd + g.hdd" & year_range == "1990:2021" & b_size == 20 & ar == 0) %>% gen_p_only(.)
...
# gr_noLX %>% filter(source == "d.l_edgar_v7 ~ d.lgdp_wb + d.lpop + d.lgdp_wb_sq + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.05 & b_size == 20 & ar == 0 & ets_yes == 0) %>% gen_p_only(.)
...
```{r, echo = FALSE, cache = TRUE}
# 
# gr_noLX %>% filter(source == "d.l_edgar_v7 ~ d.lgdp_wb + d.lpop + d.lgdp_wb_sq + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.01 & b_size == 20 & ar == 0 & ets_yes == 0) %>% gen_p_only(.)
...
# models %>% filter(source == "d.l_edgar_v7 ~ d.lgdp_wb + d.lpop + d.lgdp_wb_sq + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.001 & b_size == 20 & ar == 0 & ets_yes == 0) %>% gen_p_only(.)
...
# gr_models %>% filter(source == "d.l_edgar_v7 ~ d.lgdp_wb + d.lpop + d.lgdp_wb_sq + g.cdd + g.hdd" & year_range == "1990:2021" & b_size == 20 & ar == 1) %>% gen_p_only(.)
...
# models %>% filter(source == "d.l_edgar_v7 ~ d.lgdp_wb + d.lpop + d.lgdp_wb_sq + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.05 & b_size == 20 & ar == 1 & ets_yes == 0) %>% gen_p_only(.)
...
# models %>% filter(source == "d.l_edgar_v7 ~ d.lgdp_wb + d.lpop + d.lgdp_wb_sq + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.01 & b_size == 20 & ar == 1 & ets_yes == 0) %>% gen_p_only(.)
...
# models %>% filter(source == "d.l_edgar_v7 ~ d.lgdp_wb + d.lpop + d.lgdp_wb_sq + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.001 & b_size == 20 & ar == 1 & ets_yes == 0) %>% gen_p_only(.)
...
# gr_noLX <- here("output/temp/growth_rate_nolux.RDS")
# 
# gr_noLX %>% filter(source == "d.l_edgar_v7 ~ d.lpop + g.cdd + g.hdd" & year_range == "1990:2021" & b_size == 20 & ar == 0) %>% gen_p_only(.)
...
# gr_noLX %>% filter(source == "d.l_edgar_v7 ~ d.lpop + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.05 & b_size == 20 & ar == 0 & ets_yes == 0) %>% gen_p_only(.)
...
# gr_noLX %>% filter(source == "d.l_edgar_v7 ~ d.lpop + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.01 & b_size == 20 & ar == 0 & ets_yes == 0) %>% gen_p_only(.)
...
# models %>% filter(source == "d.l_edgar_v7 ~ d.lpop + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.001 & b_size == 20 & ar == 0 & ets_yes == 0) %>% gen_p_only(.)
...
# gr_models %>% filter(source == "d.l_edgar_v7 ~ d.lpop + g.cdd + g.hdd" & year_range == "1990:2021" & b_size == 20 & ar == 1) %>% gen_p_only(.)
...
# models %>% filter(source == "d.l_edgar_v7 ~ d.lpop + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.05 & b_size == 20 & ar == 1 & ets_yes == 0) %>% gen_p_only(.)
...
```{r, echo = FALSE, cache = TRUE}
# 
# models %>% filter(source == "d.l_edgar_v7 ~ d.lpop + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.01 & b_size == 20 & ar == 1 & ets_yes == 0) %>% gen_p_only(.)
...
# models %>% filter(source == "d.l_edgar_v7 ~ d.lpop + g.cdd + g.hdd" & year_range == "1990:2021" & p_val == 0.001 & b_size == 20 & ar == 1 & ets_yes == 0) %>% gen_p_only(.)
...
comp_lux %>% 
  ...
  ggplot(aes_(x = ~time, y = ~model)) +
      ...
      labs(x = NULL, y = NULL, title= "Model Overview", subtitle = "Specs: p = 0.01; AR = 0")


```

### ETS & ETS Price {.tabset}
```{r, echo = FALSE, fig.height = 16}
...
for(i in c("low_carbon_share_elec", "renewables_share_elec","fossil_share_elec","solar_share_elec",      "hydro_share_elec","wind_share_elec","nuclear_share_elec","oil_share_elec","coal_share_elec","gas_share_elec")){
  ...
  new <- tibble()
  for(r in 1:k){
    t <- org %>% filter(source == "low_carbon_share_elec") %>% slice(r)
...
for(n in unique(converted$indicator)){
  p <- converted %>% filter(indicator == n) %>%
  group_by(id) %>% 
  filter(!all(is.na(effect))) %>% 
  ggplot(aes_(x = ~time, y = ~model)) +
      geom_tile(aes(fill = effect), na.rm = NA) +
      ...
      theme(panel.grid = element_blank(),
            ...
            axis.text = element_text(size = 10, color = "black"),
            strip.text.y = element_text(size = 12, angle = 0)) +
      labs(x = NULL, y = NULL, title= paste0("Model Overview:",n), subtitle = "Specs: p = 0.01; AR = 0")
