...
This section only includes the aggregated measures of fossil (coal + gas + oil), renewable (solar + hydro + wind), low carbon (renewable + nuclear). For the model results with the component sources as outcome variables see [here](https://ebbam.github.io/break_scoping/output/Share_Overview.html).
